...
const Button: FC<Props> = ({
  ...
  <button
    className={clsx(
      ...
      variant === 'positive' &&
        'w-full items-center justify-center gap-3 rounded-pill bg-positive-medium text-surface-primary focus:border-2 focus:border-black focus:outline-none md:w-32 2xl:h-[54px] 2xl:p-0',
