    ...
    <div>
      <DropdownMenu.Root>
        ...
        <DropdownMenuContent sideOffset={5}>
          {items.map((item) => (
            <DropdownMenu.Item className="flex cursor-pointer items-center gap-x-6 py-2 px-4 text-neutral-500 outline-none duration-200 hover:bg-neutral-100 hover:text-secondary-medium">
              {item.icon}
