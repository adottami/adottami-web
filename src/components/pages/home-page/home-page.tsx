...
const HomePage: FC = () => (
  <div className="flex h-full w-full flex-col items-center justify-center bg-surface-primary">
    <section className="flex h-screen w-full px-6 py-12 sm:items-center sm:justify-center md:gap-6 md:px-12 md:py-20 lg:px-24 lg:py-40">
      <div className="flex w-full flex-col sm:w-1/2">
        <h1 className="text-2xl font-bold leading-none text-primary-dark sm:text-3xl lg:text-4xl">{SLOGAN_MESSAGE}</h1>
        <p
