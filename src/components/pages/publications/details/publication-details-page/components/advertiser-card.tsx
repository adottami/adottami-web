...
const AdvertiserCard: FC<Props> = ({ authenticated }) => (
  <div className="w-full max-w-[470px] rounded-lg border-2 border-neutral-100 px-6">
    <div className="flex items-center gap-4">
      ...
      <div className="flex flex-col p-6">
        ...
        <p className="text-lg font-bold text-neutral-800">Matheus Oliveira Barros</p>
      </div>
    </div>
    ...
    {authenticated ? (
      <div className="flex flex-col gap-4 p-6">
        <div className="flex items-center gap-3">
          ...
          <p className="text-neutral-800">matheus.oliveira@gmail.com</p>
        </div>
        <div className="flex items-center gap-3">
          <span className="rounded-full bg-tertiary-medium p-2 text-white">
            <Phone size={20} />
          </span>
          <p className="text-neutral-800">(83) 98719-6021</p>
        </div>
      </div>
    ) : (
